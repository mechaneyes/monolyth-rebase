...
const MailchimpFormContainer = (props) => {
  ...
  if ("document" in window.window.self) {
  ...
  var showError = function (field, error) {
    ...
    if (!message) {
      ...
      if (field.type === "radio" || field.type === "checkbox") {
        label =
          field.form.querySelector('label[htmlFor="' + id + '"]') ||
          field.parentNode;
        if (label) {
  ...
  return (
    <div className="mc__form-container">
      <form
        action="//mechaneyes.us20.list-manage.com/subscribe/post?u=2bb720cd87cb49fbf3cc52e0d&amp;id=20527040c5"
        method="post"
